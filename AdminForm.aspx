        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td class="auto-style6">
                    <asp:GridView ID="GridView1" runat="server" BackColor="#CCCCCC" Height="296px" Width="557px" ShowFooter="True" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataKeyNames="Patient_ID" DataSourceID="SqlDataSource1" ForeColor="Black">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Address_" HeaderText="Address_" SortExpression="Address_" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Patient_ID], [L_Name], [F_Name], [Email], [Address ] AS Address_, [Password], [ID_number] FROM [Patient]"></asp:SqlDataSource>
                    <table style="width:100%;">
                        <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
